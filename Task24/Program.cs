...
Console.WriteLine("Введите число: ");    // запрос на ввод от пользователя
...
if (number > 0)                       // Проверка на корректный ввод данных: является ли число натуральным?
{
    ...
    Console.WriteLine($"Сумма чисел от 1 до {number} = {SumNumbers(number)}");  // немного упростили 2 верхние строки
}
else Console.WriteLine("Введены некорректные данные! Число должно быть больше 0!");
